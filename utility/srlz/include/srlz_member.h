...
#define SRLZ_MEMBER_FORCE_UNICODE 0
#endif
...
#define SL_MEMBERA_V(v) {auto tmp = ::srlz::make_member_nvio<this_class, offsetof(this_class, v)>(#v, v, srlz::null_init_type()); ar & tmp;}
#define SL_MEMBERW_V(v) {auto tmp = ::srlz::make_member_nvio<this_class, offsetof(this_class, v)>(_LL(#v), v, srlz::null_init_type()); ar & tmp;}
