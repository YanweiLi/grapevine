...
//////////////////////////////////////////////////////////////////////////
// IUnknown
inline static void serialize_pointer_load(IUnknown*
	, iarchive_xparam const& ar
	, IUnknown*& t)
{
	IUnknown* pUnk = NULL;
...
template <typename T>
inline static void serialize_pointer_save(IUnknown*
	, oarchive_xparam& ar
	, T*const& t)
{
...
//////////////////////////////////////////////////////////////////////////
// ATL CComPtr
inline static void serialize_load(iarchive_xparam const& ar
	, ATL::CComPtr<IUnknown>& t)
{
	IUnknown* pUnk = NULL;
	if(ar.value(pUnk) && pUnk)
	{
...
inline static void serialize_load(iarchive_xparam const& ar
	, _com_ptr_t< _com_IIID<IUnknown, _IID> >& t)
{
	IUnknown* pUnk = NULL;
	if(ar.value(pUnk) && pUnk)
	{
