...
#include "./srlz_base.h"
#include "utility/xparam/xml/str_conv.h"
#include <string>
...
template <> struct right_int_getter<4> {public :typedef unsigned long type;};
template <> struct right_int_getter<8> {public :typedef unsigned long long type;};
